...
public class IKMover : IKBase
{
	...
	bool SolveIKPosition(Transform Origin,Transform Target,ref float TargetPosition)
	{
	...
	float ConvertPosition(float Position)
	{
	...
	// and false otherwise
	bool LimitPosition(float Minimum,float Maximum,ref float Position)
	{
		float   Swap;
	...
	// Animation stage
	void AnimatePosition(ref float DstPosition,float SrcPosition,bool IsLimited)
	{
